        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" title="{{ trans('admin/common.create') }}" class="btn btn-primary btn-sm btn-create" href="{{ url('admin/users/create') }}"><i class="icon-plus"></i> {{ trans('admin/users.add_user') }}</a>
                        ...
                        <tbody>
                        	@foreach($users as $key=>$val)
                        		<tr>
                        			...
                        			<td>
                        				@if($val->status==1)
											<a href="javascript:void(0);" data-href="{{ url('admin/users/status') }}" data-status="0" data-id="{{ $val->id }}" class="btn btn-success btn-sm btn-status"><i class="icon-tick"></i> Active</a>
										@else
											<a href="javascript:void(0);" data-href="{{ url('admin/users/status') }}" data-status="1" data-id="{{ $val->id }}" class="btn btn-warning btn-sm btn-status"><i class="icon-warning2"></i> Inactive</a>
										@endif
                        			</td>
                        			<td>
                        				<a href="{{ url('admin/users/'.$val->id.'/edit') }}" class="btn btn-primary btn-sm btn-edit"><i class="icon-pencil"></i> Edit</a>
										<a href="javascript:void(0);" data-href="{{ url('admin/users/destroy') }}" data-id="{{ $val->id }}"  class="btn btn-danger btn-sm btn-delete"><i class="icon-trash2"></i> Delete</a>
                                        {!! Form::open([
                                                'method'=>'GET',
                                                'url' => ['/admin/users/login-as', $val->id],
                                                'style' => 'display:inline'
                                            ]) !!}
                                            {!! Form::button('<i class="icon-log-out" aria-hidden="true"></i> Login', array(
                                                    'type' => 'submit',
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".modal").on("show.bs.modal", function(e) {
                ...
                var url = "{{ url('admin/users') }}/"+target+id;
