        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" title="{{ trans('admin/common.view') }}" class="btn btn-primary btn-sm btn-view" href="{{ url('admin/users') }}"><i class="icon-eye"></i> {{ trans('admin/common.view') }}</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="main-content">
    ...
    <div class="row gutters">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            @if(isset($user))
                {!! Form::model($user, ['route' => array('users.update', $user->id), 'method' => 'PATCH', 'id' => 'form', 'novalidate' => 'novalidate', 'files'=>true]) !!}
            @else
                {!! Form::open(['route' => 'users.store', 'id' => 'form', 'novalidate' => 'novalidate', 'files'=>true]) !!}
            @endif
                                    ...
                                    <div class="baguetteBoxThree gallery">
                                        <div class="row gutters">
                                            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-3 col-6">
                                                <a href="{{ $user->image }}" data-toggle="tooltip" title="{{ trans('admin/users.image') }}" class="effects">
                                                    <img src="{{ $user->image }}" class="img-thumbnail" style="width: 200px;" />
                                                    <div class="overlay">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('firstname',trans('admin/users.firstname').config('common.required_sign'),[],false) !!}
                                {!! Form::text('firstname',old('firstname'), array('class'=>'form-control','id' => 'firstname', 'max'=>191)) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                {!! Form::label('lastname',trans('admin/users.lastname').config('common.required_sign'),[],false) !!}
