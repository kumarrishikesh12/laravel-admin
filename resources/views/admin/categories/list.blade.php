        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" title="{{ trans('admin/common.create') }}" class="btn btn-primary btn-sm btn-create" href="{{ url('admin/categories/create') }}"><i class="icon-plus"></i> {{ trans('admin/common.create') }}</a>
                    ...
                    <table id="data-table" class="table table-hover table-striped">
                        <thead class="text-uppercase">
                            <tr>
                                ...
                                <th>{{ trans('admin/categories.parent') }}</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".modal").on("show.bs.modal", function(e) {
                ...
                var url = "{{ url('admin/categories') }}/"+target+id;
            ...
            var table = $('#data-table').on( 'init.dt', function () {     
                    ...
                    $.each( jsn, function(i, item){
                        ...
                        $.each( item.data, function(j, val){
                            ...
                            var subtext = val['data-subtext']==undefined?'':val['data-subtext'];
                            select.append( '<option '+sel+' data-subtext="'+subtext+'" value="'+ val['key'] +'" data-icon="'+ val['icon'] +'">'+val['value']+'</option>' );
                        });
