<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel">{{ $sub_category->name }}</h5>
            ...
            <div class="baguetteBoxThree gallery">
                <div class="row gutters">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                        <a href="{{ $sub_category->image }}" data-toggle="tooltip" title="{{ trans('admin/polls.image') }}" class="effects">
                            <img src="{{ $sub_category->image }}" class="img-thumbnail" style="width: 200px; height: 150px;" />
                            <div class="overlay">
