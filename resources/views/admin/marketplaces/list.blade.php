        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                <div class="daterange-container">
                    <a data-toggle="tooltip" title="{{ trans('admin/common.create') }}" class="btn btn-primary btn-sm btn-create" href="{{ url('admin/marketplaces/create') }}"><i class="icon-plus"></i> {{ trans('admin/common.create') }}</a>
                    ...
                    <table id="data-table" class="table table-hover table-striped">
                        <thead class="text-uppercase">
                            <tr>
                                ...
                                <th>{{ trans('admin/marketplaces.name') }}</th>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $(".modal").on("show.bs.modal", function(e) {
                ...
                var url = "{{ url('admin/marketplaces') }}/"+target+id;
            ...
            var table = $('#data-table').on( 'init.dt', function () {     
                    ...
                    "order": [[ 1, "asc" ]],
                    "ajax": {
                        "url": "{{ url('admin/marketplaces/data') }}",
                        "type": 'POST',
                        "headers": {
                ...
                bootbox.confirm({
                    ...
                    callback: function (result) {
                        if(result===true){
                            ...
                            $.ajax({
                                "url": "{{ url('admin/marketplaces/destroy') }}",
                                "type": "POST",
                                "headers": {
                                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                                },
